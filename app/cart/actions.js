...
export async function getCurrentProducts() {
  ...
  // console.log('productQuantityCookie:', productQuantityCookie); // looks good
  // console.log('getCurrentProducts:', getCurrentProducts);
  ...
  // console.log('productQuantity:', productQuantity); // looks good
